...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Jul 2022 pada 04.39
...
(1, 'Freebase', '2022-06-28 22:39:24', '2022-06-29 00:22:32'),
(2, 'Salt Nicotine', '2022-06-29 00:22:48', '2022-06-29 00:22:48'),
(3, 'Pods Friendly', '2022-06-29 00:23:03', '2022-06-29 00:23:03'),
(4, 'Automizher', '2022-06-29 20:57:02', '2022-06-29 20:57:02'),
(5, 'Acesicoris', '2022-06-29 20:57:29', '2022-06-29 20:57:29');
...
CREATE TABLE `penjualan_detail` (
  ...
  `jumlah` int(11) NOT NULL,
  `diskon` int(11) NOT NULL DEFAULT 0,
  `keuntungan` int(11) NOT NULL DEFAULT 0,
  `subtotal` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(3, 1, 'P000003', 'Avoshi', NULL, 130000, 0, 150000, 45, '2022-06-29 21:00:50', '2022-06-30 17:56:35'),
(4, 1, 'P000004', 'Pop Sens Grape', NULL, 60000, 0, 80000, 38, '2022-06-29 21:02:06', '2022-06-30 17:56:35');
...
('kp6DikkcCeCFETr6RRis5DUxj42fa7lOMOGYj228', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Safari/537.36', '', 1656640640);
...
(1, 'Suplier cavendiah panjer', 'Bumi', '08123456789', '2022-06-29 19:55:49', '2022-06-29 20:58:42');
