...
class PenjualanDetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $detail->keuntungan = ($produk->harga_jual - $produk->harga_beli) * 1;
    ...
    public function update(Request $request, $id)
    {
        ...
        $detail->keuntungan = ($detail->harga_jual - $detail->harga_beli) * $request->jumlah ?? 1;
        $detail->subtotal = ($detail->harga_jual * $request->jumlah) - $detail->diskon;
        $detail->update();
    }
